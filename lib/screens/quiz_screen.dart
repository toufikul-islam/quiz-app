...
class _QuizScreenState extends State<QuizScreen> {
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildAnswerButton('A', question.optionA),
                  const SizedBox(height: 12),
                  _buildAnswerButton('B', question.optionB),
                  const SizedBox(height: 12),
                  _buildAnswerButton('C', question.optionC),
                  const SizedBox(height: 12),
                  _buildAnswerButton('D', question.optionD),
                  const SizedBox(height: 32),
                  if (_answered)
                    SizedBox(
                      height: 50,
  ...
  Widget _buildAnswerButton(String letter, String text) {
